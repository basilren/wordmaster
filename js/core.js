...
function updHeader(id){
  ...
  var m={pageLogin:['WordMaster','\u82F1\u8BED\u80CC\u8BF5\u5C0F\u52A9\u624B'],pageHome:['WordMaster',CUR_USER?'Hi, '+CUR_USER+' \uD83D\uDC4B':''],pageWordbank:['\u{1F4DA} \u8BCD\u5E93\u7BA1\u7406','\u4E0A\u4F20\u548C\u7BA1\u7406\u5355\u5143\u8BCD\u5E93'],pageEdit:['\u270F\uFE0F \u7F16\u8F91\u8BCD\u5E93',''],pageDetail:['\u{1F4D6} \u8BCD\u5E93\u8BE6\u60C5',''],pageUnitSel:['\u{1F4DD} \u7EFC\u5408\u68C0\u6D4B','\u9009\u62E9\u5355\u5143\u51FA\u9898'],pageQuiz:['\u{1F4DD} \u7EFC\u5408\u68C0\u6D4B',''],pageFlash:['\u{1F0CF} \u7FFB\u5361\u5B66\u4E60',''],pageVoice:['\u{1F3A4} \u8BED\u97F3\u6717\u8BFB',''],pageErr:['\u{1F4D5} \u9519\u9898\u5E93','\u91CD\u70B9\u590D\u4E60\u6613\u9519\u5185\u5BB9'],pageStats:['\u{1F4CA} \u5B66\u4E60\u8BB0\u5F55','\u67E5\u770B\u5B66\u4E60\u6570\u636E']};
